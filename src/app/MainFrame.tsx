      ...
      <Layout className="layout">
          ...
          >
            <Menu.ItemGroup title={i18n('menuItems.menu')}>
              ...
              <Menu.Item key={5} style={{marginBottom: '8px'}}>
                <Link to="/admin">
                  <Icon type="usergroup-add" style={menuIconStyle}/><span>{i18n('menuItems.admin')}</span>
                </Link>
              </Menu.Item>
        ...
        <Layout style={{padding: '0 24px 24px', marginLeft: marginLeft, transition: '0.5s'}}>
          <Row type="flex" justify="space-between" style={{margin: 20}}>
            <Button type="primary" shape={'circle'} onClick={this.toggleCollapsed}
                    style={{marginTop: 16, marginBottom: 5, zIndex: 100}}>
